CREATE TABLE base_espacial (
    ...
    agua_usada_por_dia INT DEFAULT 0,
    nutrientes_usados_por_dia INT DEFAULT 0,
    energia_usada_por_dia INT DEFAULT 0,
    oxigeno_usado_por_dia INT DEFAULT 0,
    comida_usada_por_dia INT DEFAULT 0
);
